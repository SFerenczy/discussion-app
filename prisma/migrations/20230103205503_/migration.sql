...
CREATE TABLE "Question" (
    ...
    CONSTRAINT "Question_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Argument" (
    ...
    "creatorId" TEXT NOT NULL,
    CONSTRAINT "Argument_discussionId_fkey" FOREIGN KEY ("discussionId") REFERENCES "Discussion" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
